...
public class QsTuner extends Fragment implements Callback {
    ...
    private static class DraggableTile extends QSTile<QSTile.State>
        ...
        private int getIcon() {
            ...
            else if (mSpec.equals("phone")) return R.drawable.ic_phone;
            else if (mSpec.equals("messaging")) return R.drawable.ic_messaging;
            else if (mSpec.equals("contacts")) return R.drawable.ic_contacts;
            else if (mSpec.equals("email")) return R.drawable.ic_email;
