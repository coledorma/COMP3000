...
public class ContactsTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        state.value = true;
        state.visible = true;
        state.label = "Contacts";
        state.icon = mEnable;
        state.contentDescription =  mContext.getString(R.string.accessibility_quick_settings_contacts);
    }
    ...
    protected String composeChangeAnnouncement() {
        if (mState.value) {
            return mContext.getString(R.string.accessibility_quick_settings_contacts);
        } else {
            return mContext.getString(R.string.accessibility_quick_settings_contacts);
        }
    }
