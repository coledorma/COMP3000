...
public class MessagingTile extends QSTile<QSTile.BooleanState> {
    ...
    public void handleClick() {
        ...
        try {
            i = manager.getLaunchIntentForPackage("com.android.messaging");
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        state.value = true;
        state.visible = true;
        state.label = "Messaging";
        state.icon = mEnable;
        state.contentDescription =  mContext.getString(R.string.accessibility_quick_settings_messaging);
    }
    ...
    protected String composeChangeAnnouncement() {
        if (mState.value) {
            return mContext.getString(R.string.accessibility_quick_settings_messaging);
        } else {
            return mContext.getString(R.string.accessibility_quick_settings_messaging);
        }
    }
